pub mod annotated_string_iterator;
pub mod annotated_string_part;
pub mod annotated_type;
pub mod annotation;

use crate::{
    editor::annotated_string::{
        annotated_string_iterator::AnnotatedStringIterator,
        annotated_string_part::AnnotatedStringPart, annotated_type::AnnotationType,
...
impl fmt::Display for AnnotatedString {
